...
public class Search_shop extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //アダプタ
        ad_cate1 = new ArrayAdapter<String>(Search_shop.this, android.R.layout.simple_spinner_item);
        ad_cate2 = new ArrayAdapter<String>(Search_shop.this, android.R.layout.simple_spinner_item);
        ad_cate3 = new ArrayAdapter<String>(Search_shop.this, android.R.layout.simple_spinner_item);
        ...
        sp_1.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                ...
                //Toast.makeText(Search_shop.this,item,Toast.LENGTH_SHORT).show();
                ad_cate1.clear();
                if(position != 0 ) {
        ...
        searchButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                //Toast.makeText(Search_shop.this, params, Toast.LENGTH_LONG).show();
            ...
            public void onResponse(String response) {
                try {
                    ...
                    for (int i = 0; i < count.length(); i++) {
                        ...
                        //Toast.makeText(Search_shop.this,str,Toast.LENGTH_SHORT).show();
                ...
                public void onErrorResponse(VolleyError error) {
                    ...
                    Toast.makeText(Search_shop.this, "通信に失敗しました。" + error.toString(), Toast.LENGTH_SHORT).show();
                }
        }) {
                @Override
                //サーバに送信する文字列を設定
                     ...
                     public void onResponse(String response) {
                         try {
                             ...
                             for (int i = 0; i < count.length(); i++) {
                                 ...
                                 arrayList.add(str);
                                 //Toast.makeText(Search_shop.this,arrayList.get(i),Toast.LENGTH_SHORT).show();
                             }
                             //エラーをToastで表示
                         } catch (JSONException e) {
                             e.printStackTrace();
