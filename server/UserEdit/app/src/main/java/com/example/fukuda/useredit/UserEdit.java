package com.example.fukuda.useredit;
...
//アクションバーに戻るボタンを実装
        ...
        //アカウント名をセット
        accountNameText.setText(MYNAME);
        ...
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                if (accountflag == 1 && passflag == 1 && passcheckflag == 1 && equalflag == 1 && ageflag == 1 && sexflag == 1 && areaflag == 1) {
                    Edit(Passtext, agetext, sextext, area);
                    nextPage();
                }
            }
        });
    ...
    private void Edit( final String pass, final String agetext, final String areatext, final String sextext) {
