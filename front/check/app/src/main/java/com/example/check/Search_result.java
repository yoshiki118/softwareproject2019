...
public class Search_result extends AppCompatActivity implements AdapterView.OnItemClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            /* 非同期通信処理の呼び出し */
            new HttpResponse(this, adapter, listView, shopList).execute(new URL("https://api.gnavi.co.jp/RestSearchAPI/v3/?keyid=2d6d76dbefd64c4b99ee433ca37f47a1"+ "&hit_per_page=1"+params));
